...
var ModalForm = /*#__PURE__*/function () {
  ...
  _createClass(ModalForm, [{
    ...
    value: function maskForPhone() {
      var phoneInputs = document.querySelectorAll('.form__input_phone');
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          if (input) {
            this.mask = new _imask.default(input, {
  ...
  _createClass(TechnicalFunctions, [{
    ...
    value: function smoothNavigation() {
      ...
      if (menuLinks.length != 0) {
        var _iterator2 = _createForOfIteratorHelper(menuLinks),
          _step2;
        try {
